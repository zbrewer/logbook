...
class MedicalTest < ActiveSupport::TestCase
  ...
  test "first class medical" do
    ...
    assert_equal Date.new(2015, 6, 30), Medical.calendar_months_from(Date.new(2013, 10, 12), 20)
  ...
  test "third class medical" do
    ...
    assert_equal 21, medical.age_at_exam
    assert_equal Date.new(2015, 4, 30), Medical.calendar_months_from(Date.new(2015, 4, 1), 0)
