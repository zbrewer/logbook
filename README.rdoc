...
This project has unit tests that can be run with the following command: `$ rake test:all`

## Resetting the database

The database can be reset with the following command `$ rake db:reset`
